...
def main( args=None ):
    ...
    # print("Messages for needle shapes")
    # needle_shape_topics = "/needle/state/current_shape"
    # needle_shape = bag.get_messages(topic_name = needle_shape_topics, generator_count=len(needle_shape_topics))

    # idx = 0
    # while idx < 5:
    #     msgs = next(needle_shape)
    #     for msg in msgs:
    #         print(f"  {msg}")
    #     print(100*"=")
    #     idx+=1
    ...
    bag.parse_data(needle=True, robot=False)
